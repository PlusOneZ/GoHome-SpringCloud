...
public class StayEntity {
    ...
    private byte publicBathroom;
    private byte publicToilet;
    private byte nonBarrierFacility;
    ...
    public byte getNonBarrierFacility() {
