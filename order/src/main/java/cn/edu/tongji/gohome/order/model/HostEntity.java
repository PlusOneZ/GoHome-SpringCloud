...
public class HostEntity {
    ...
    @Basic
    @Column(name = "host_create_time", nullable = true)
    ...
    @Basic
    @Column(name = "host_resident_id", nullable = false, length = 18)
    ...
    @Basic
    @Column(name = "host_real_name", nullable = false, length = 40)
    ...
    @Basic
    @Column(name = "host_state", nullable = false)
